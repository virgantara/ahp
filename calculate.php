...
$data = '
  ...
  echo "<b><h3>Pairwise Comparison Matrix</h3></b>";
  echo "<table>";
   for ($i=0; $i<$row; $i++) { 
     echo "<tr>";
     for ($j=0; $j<$col; $j++) { 
  ...
  $ar1=array();
  $ar2=array();
  echo "<br><b><h3>Normalized Matrix</h3></b>";
  echo "<table>";
   for ($i=0; $i<$col; $i++) { 
     echo "<tr>";
     for ($j=0; $j<$row; $j++) { 
...
echo "<br><b><h3>Pairwise Matrix (Provider)</h3></b>";
	...
	for($i=0;$i<$count_c+1;$i++){
		...
		for($j=0;$j<$count_c+1;$j++){
			if ($j==0 && $i==0 ){
				...
				echo "<td>".$array_d[$j-1]['value'][$array_alt[$q]]/$array_d[$i-1]['value'][$array_alt[$q]]."</td>";
			}
		}
		echo "</tr>";
	}
